...
extern void PiOLED_DrawRectPat(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color, uint16_t pat );
extern void PiOLED_FillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color);
extern void PiOLED_FillRectPat(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color, uint16_t pat );
